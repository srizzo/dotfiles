...
export DOTFILES_IDEA_HOME="$DOTFILES_JETBRAINS_HOME/IntelliJIdea2020.3"
export DOTFILES_MINE_HOME="$DOTFILES_JETBRAINS_HOME/RubyMine2020.3"
...
function idea_keymaps_dist {
  ...
  cp "$DOTFILES_SHARED_HOME/jba_config/mac.keymaps/CodeBuddyKeymap.xml" \
     "$CODE_BUDDY_PLUGIN_HOME/build/idea-sandbox/config/keymaps/CodeBuddyKeymap.xml"
  cp "$DOTFILES_SHARED_HOME/jba_config/mac.keymaps/CodeBuddyKeymap.xml" \
     "$RUBY_CONVENTIONS_PLUGIN_HOME/build/idea-sandbox/config/keymaps/CodeBuddyKeymap.xml"
}
